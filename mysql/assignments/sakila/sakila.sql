...
SELECT address.city_id, city.city, first_name, last_name, email, address.address FROM customer
...
SELECT film.film_id, title, film_actor.actor_id, CONCAT(actor.first_name, " ", actor.last_name) AS actor_name FROM film_actor
...
SELECT actor.actor_id, CONCAT(actor.first_name, " ", actor.last_name) AS actor_name, film.film_id, title, description, release_year, rating, special_features, category.name AS genre FROM film
JOIN film_actor ON film.film_id = film_actor.film_id
JOIN actor ON film_actor.actor_id = actor.actor_id
JOIN film_category ON film.film_id = film_category.film_id
JOIN category ON film_category.category_id = category.category_id
